...
exports.RemoteObjectStorage = void 0;
...
class RemoteObjectStorage {
    ...
    saveChanges(delta) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.dataProvider.saveData(storageDataObject);
        });
    }
}
exports.RemoteObjectStorage = RemoteObjectStorage;
class StaticPage {
...
//# sourceMappingURL=remoteObjectStorage.js.map