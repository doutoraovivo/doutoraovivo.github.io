...
exports.ApiListTiles = void 0;
const ko = require("knockout");
const Constants = require("../../../../../constants");
const api_list_tiles_html_1 = require("./api-list-tiles.html");
const decorators_1 = require("@paperbits/common/ko/decorators");
const apiService_1 = require("../../../../../services/apiService");
const routeHelper_1 = require("../../../../../routing/routeHelper");
let ApiListTiles = class ApiListTiles {
    constructor(apiService, routeHelper) {
        ...
        this.selectedApiName = ko.observable().extend({ acceptChange: this.allowSelection });
...
], ApiListTiles.prototype, "allowSelection", void 0);
__decorate([
    (0, decorators_1.Param)(),
    __metadata("design:type", Function)
], ApiListTiles.prototype, "defaultGroupByTagToEnabled", void 0);
__decorate([
    (0, decorators_1.Param)(),
    __metadata("design:type", Function)
], ApiListTiles.prototype, "detailsPageUrl", void 0);
__decorate([
    (0, decorators_1.OnMounted)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], ApiListTiles.prototype, "initialize", null);
ApiListTiles = __decorate([
    (0, decorators_1.RuntimeComponent)({
        selector: "api-list-tiles"
    }),
    (0, decorators_1.Component)({
        selector: "api-list-tiles",
        template: api_list_tiles_html_1.default
    }),
    __metadata("design:paramtypes", [apiService_1.ApiService,
        routeHelper_1.RouteHelper])
], ApiListTiles);
exports.ApiListTiles = ApiListTiles;
//# sourceMappingURL=api-list-tiles.js.map